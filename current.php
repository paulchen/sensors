...
$query2 = 'SELECT UNIX_TIMESTAMP(timestamp) timestamp, value FROM sensor_cache WHERE sensor = ? AND what = ? AND DATE_SUB(NOW(), INTERVAL 1 DAY) < timestamp ORDER BY id DESC LIMIT 0, 1';
